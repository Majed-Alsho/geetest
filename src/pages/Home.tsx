      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        ...
        <div className="container-wide relative z-10">
          <div className="max-w-4xl">
            ...
            >
              <Link to="marketplace" className="btn-accent text-base px-8 py-4">
                Browse Verified Listings
                <ArrowRight className="w-5 h-5" />
              </Link>
              <Link to="create-listing" className="btn-secondary text-base px-8 py-4">
                List Your Business
              </Link>
            </motion.div>
            ...
            <GlassPanel className="p-8 md:p-12 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link to="marketplace" className="btn-accent group">
                    Browse Verified Listings
