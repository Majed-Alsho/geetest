...
import { getListingById, formatCurrency, FEATURED_MONTHLY_PRICE } from '@/lib/data';
...
export default function ListingDetail() {
  const { selectedListingId, navigateTo } = useNavigation();
  ...
  if (!listing) {
    return (
        ...
        <div className="section-padding container-wide text-center">
          ...
          <button onClick={() => navigateTo('marketplace')} className="btn-primary">
